...
let
  ...
  platforms = {
    x86_64-linux = {
      platform = "linux-x64";
      hash = "sha256-OmJKWnzXm7rU0yvX2zbxGX7PRYvFvx4q7YGDSgGtPvA=";
    };
    aarch64-linux = {
      platform = "linux-arm64";
      hash = "sha256-e/nzOswSTfmrzPbyNmOXqCp0A3jVNfoS1Cb6d/28mUY=";
    };
    x86_64-darwin = {
      platform = "darwin-x64";
      hash = "sha256-s+4yN6AZuKWrswCPHH3dRilaDm5lq5RUWnnJuZfciSg=";
    };
    aarch64-darwin = {
